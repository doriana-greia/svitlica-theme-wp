...
function aletheme_get_options() {
    ...
    $headerfont = array_merge(ale_get_safe_webfonts(), ale_get_google_webfonts(), ale_get_self_webfonts());

    $selffont = array_merge( ale_get_self_webfonts());
    ...
    $options[] = array( "name" => "Select the body Font from Local",
                        "desc" => "The default Font is - ProfontsBureau",
                        "id" => "ale_selffont",
                        "std" => "Profonts+Bureau",
                        "type" => "select",
                        "options" => $selffont);

    $options[] = array( "name" => "Select the body Font (Extended) from Local",
                        "desc" => "The default Font (extended) is - 600",
                        "id" => "ale_selffontx",
                        "std" => "600",
                        "type" => "text",
    ...
    $options[] = array( 'name' => "H1 Style",
                        ...
                        'id' => 'ale_h1sty',
                        'std' => array('size' => '22px','face' => 'Profonts+Bureau','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H2 Style",
                        'desc' => "Change the h2 style",
                        'id' => 'ale_h2sty',
                        'std' => array('size' => '20px','face' => 'Profonts+Bureau','style' => 'normal','color' => '#333333'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H3 Style",
                        'desc' => "Change the h3 style",
                        'id' => 'ale_h3sty',
                        'std' => array('size' => '18px','face' => 'Profonts+Bureau','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H4 Style",
                        'desc' => "Change the h4 style",
                        'id' => 'ale_h4sty',
                        'std' => array('size' => '16px','face' => 'Profonts+Bureau','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H5 Style",
                        'desc' => "Change the h5 style",
                        'id' => 'ale_h5sty',
                        'std' => array('size' => '14px','face' => 'Profonts+Bureau','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "H6 Style",
                        'desc' => "Change the h6 style",
                        'id' => 'ale_h6sty',
                        'std' => array('size' => '12px','face' => 'Profonts+Bureau','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');

    $options[] = array( 'name' => "Body Style",
                        'desc' => "Change the body font style",
                        'id' => 'ale_bodystyle',
                        'std' => array('size' => '11px','face' => 'Profonts+Bureau','style' => 'normal','color' => '#111111'),
                        'type' => 'typography');
