 ...
 * @return array
 */
function ale_get_self_webfonts() {
    return array(
        'ProfontsBureau'	            => 'ProfontsBureau',
        'ProfontsBureau-Bold'			=> 'ProfontsBureau-Bold',
        'Verdana'			            => 'Verdana, Geneva',
        'SF-UI-Display-Light'			=> 'SF-UI-Display-Light',
        'SF-UI-Display-Semibold'	    => 'SF-UI-Display-Semibold',
        'SF-UI-Display-Thin'			=> 'SF-UI-Display-Thin',
        'helveticaneuecyr-italic'	    => 'helveticaneuecyr-italic',
    );
}
