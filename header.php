...
<body <?php if(is_page_template('page-home.php')){ body_class('home'); } if(is_page_template('template-contact.php')){ body_class('contact-page'); }  if(is_blog()){ body_class('events'); } else { body_class(); } ?> >
